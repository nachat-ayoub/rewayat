...
const Footer = () => {
  return (
    <footer
      dir="ltr"
      className="text-gray-200 p-4 bg-gradient-primary shadow md:px-6 md:py-5 font-bold"
    >
      <div className="flex flex-col items-center sm:flex-row sm:justify-between">
        <Link href="/">
          <a className="text-gray-200 flex items-center mb-4 sm:mb-0">
            <BigLogoSvg />
          </a>
        </Link>
        <ul className="flex flex-wrap items-center my-3 text-sm sm:my-0">
          <li>
            <Link href="#about">
